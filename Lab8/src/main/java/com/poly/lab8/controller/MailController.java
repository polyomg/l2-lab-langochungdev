...
public class MailController {
    ...
    public String form(Model model) {
    	model.addAttribute("mail", MailService.Mail.builder().build());
        return "mail/form";
    }

    @PostMapping("/send-direct")
    public String sendDirect(@ModelAttribute("mail") MailService.Mail mail, @RequestParam("files") MultipartFile[] files, Model model) {
    ...
    public String sendQueue(@ModelAttribute("mail") MailService.Mail mail, @RequestParam("files") MultipartFile[] files, Model model) {
        attachFiles(mail, files);
    ...
    private void attachFiles(MailService.Mail mail, MultipartFile[] files) {
        try {
